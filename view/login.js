...
(function () {
    ...
    // Single toggle (login page)
    var singleBtn = document.getElementById('togglePw');
    var singleInput = document.getElementById('password');
    var singleIcon  = document.getElementById('eyeIcon');
    if (singleBtn && singleInput && singleIcon) {
        singleBtn.addEventListener('click', function () {
            var show = singleInput.type === 'password';
            singleInput.type   = show ? 'text' : 'password';
            singleIcon.innerHTML = show ? eyeClosed : eyeOpen;
        });
    }

    // Multiple toggles (profile / register page) using data-target
