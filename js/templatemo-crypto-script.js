        ...
        document.querySelectorAll(".copy-btn").forEach(function (btn) {
            btn.addEventListener("click", function () {
                const addressElement =
                    btn.parentElement.querySelector(".wallet-address");
                if (addressElement) {
                    const address = addressElement.textContent;
                    navigator.clipboard.writeText(address).then(function () {
                        // Show success state
                        btn.innerHTML =
                            '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6b8e6b" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>';
    ...
    function initSearch() {
        ...
        if (searchInput) {
            searchInput.addEventListener("input", function (e) {
                ...
                document
                    .querySelectorAll(".market-table tbody tr")
        ...
        authTabs.forEach(function (tab) {
            tab.addEventListener("click", function () {
                ...
                if (tab.dataset.form === "login") {
                    ...
                    if (formHeader) {
                        formHeader.querySelector("h1").textContent =
                            "Welcome Back";
