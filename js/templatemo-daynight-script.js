/* ========================================
   DigitEra Admin - JavaScript
   ======================================== */

/*

TemplateMo 608 DigitEra Admin
...
function updateMessageView(index) {
    ...
    document.querySelector(".message-view-sender-name").textContent =
        msg.sender;
    document.querySelector(".message-view-sender-email").textContent =
        msg.email;
...
function initToggles() {
    ...
    toggles.forEach((toggle) => {
        toggle.addEventListener("change", function () {
            console.log(
                `${this.id} is now ${this.checked ? "enabled" : "disabled"}`,
            );
        });
    });
}
