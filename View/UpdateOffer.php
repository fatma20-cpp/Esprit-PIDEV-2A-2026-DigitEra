...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($isValid) {
        ...
        $newOffer = new Offre($title, $description, $budget, 1);
        $newOffer->setCategory($category);
        $newOffer->setDeadline($deadline);
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                ...
                <h1 class="greeting">Update Offer</h1>
                <p class="greeting-sub">Modify your project details</p>
            ...
            <div class="offer-grid">
                ...
                <div class="card">
                    ...
                    <p class="settings-desc">Update all required fields</p>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-input"
                                        value="<?php echo htmlspecialchars($_POST['title'] ?? $offer['title']); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-input"
                                        style="min-height:160px;"><?php echo htmlspecialchars($_POST['description'] ?? $offer['description']); ?></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="budget" class="form-input"
                                        value="<?php echo htmlspecialchars($_POST['budget'] ?? $offer['budget']); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-input">
                                        ...
                                        <option value="DEV"
                                            <?php if(($offer['category'] ?? '')=="DEV") echo "selected"; ?>>
                                            Development</option>
                                        <option value="UI"
                                            <?php if(($offer['category'] ?? '')=="UI") echo "selected"; ?>>
                                            UI/UX
                                        </option>
                                        <option value="MARKETING"
                                            <?php if(($offer['category'] ?? '')=="MARKETING") echo "selected"; ?>>
                                            Marketing
                                        </option>
                                        <option value="DATA"
                                            <?php if(($offer['category'] ?? '')=="DATA") echo "selected"; ?>>
                                            Data</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="deadline" class="form-input"
                                        value="<?php echo htmlspecialchars($_POST['deadline'] ?? $offer['deadline']); ?>">
